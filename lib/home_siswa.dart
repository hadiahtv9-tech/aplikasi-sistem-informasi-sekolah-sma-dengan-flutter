...
class _HomeSiswaState extends State<HomeSiswa> {
  ...
  final List<Map<String, dynamic>> homeMenuItems = const [
    {'icon': Icons.book, 'label': 'Jadwal', 'route': '/jadwal'},
    {'icon': Icons.assignment, 'label': 'Nilai', 'route': '/nilai'},
    {'icon': Icons.task, 'label': 'Tugas', 'route': '/tugas'},
  ];
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    item['icon'],
                    size: 48,
                    color: const Color.fromARGB(255, 37, 136, 154),
                  ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Siswa - MAN Cipasung"),
        centerTitle: true,
        elevation: 0,
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: _onItemTapped,
        selectedItemColor: const Color.fromARGB(255, 76, 144, 175),
        items: const [
